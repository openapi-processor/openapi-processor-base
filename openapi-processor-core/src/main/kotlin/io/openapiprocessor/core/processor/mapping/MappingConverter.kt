...
import io.openapiprocessor.core.processor.mapping.parser.Mapping.Kind.ANNOTATE
import io.openapiprocessor.core.processor.mapping.parser.Mapping.Kind.IMPLEMENT
import io.openapiprocessor.core.processor.mapping.parser.antlr.parseMapping
import java.util.stream.Collectors
import io.openapiprocessor.core.processor.mapping.Map as YamlMap
import io.openapiprocessor.core.processor.mapping.Mapping as YamlMapping
import io.openapiprocessor.core.processor.mapping.parser.Mapping as ParserMapping
import io.openapiprocessor.core.processor.mapping.parser.MappingType as ParserMappingType
 ...
 */
class MappingConverter(val mapping: YamlMapping) {
    ...
    private fun convertGlobalMappings(map: YamlMap): Mappings {
    ...
    private fun convertInlineGenerics(targetGenericTypes: List<ParserMappingType>): List<TargetType> {
