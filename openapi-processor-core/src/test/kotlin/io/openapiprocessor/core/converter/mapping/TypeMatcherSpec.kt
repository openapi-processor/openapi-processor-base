...
class TypeMatcherSpec: StringSpec({
    ...
    "does not match if name differs" {
        ...
        val matcher = TypeMatcher(MappingQueryX(createSchema("Name", null)))
    ...
    "does not match if format differs" {
        ...
        val matcher = TypeMatcher(MappingQueryX(createSchema("Name", "a format")))
    ...
    "matches by name and format" {
        ...
        val matcher = TypeMatcher(MappingQueryX(createSchema("Name", "format")))
    ...
    "does not match primitive if type differs" {
        ...
        val matcher = TypeMatcher(MappingQueryX(createPrimitiveSchema("type", null)))
    ...
    "does not match primitive if format differs" {
        ...
        val matcher = TypeMatcher(MappingQueryX(createPrimitiveSchema("type", "a format")))
    ...
    "matches primitive by type and format" {
        ...
        val matcher = TypeMatcher(MappingQueryX(createPrimitiveSchema("type", "format")))
    ...
    "matches array by name" {
        ...
        val matcher = TypeMatcher(MappingQueryX(createArraySchema()))
